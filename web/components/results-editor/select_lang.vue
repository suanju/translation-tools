                    ...
                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <TransitionChild as="template" enter="ease-out duration-300"
                            ...
                            <DialogPanel
                                ...
                                <!-- 选择区域 -->
                                <div class="mt-4 border rounded-md border-slate-300">
                                    <fieldset class="h-80  overflow-y-auto">
                                        <legend class="sr-only">Notifications</legend>
                                        <div class="space-y-5 py-4 px-4  hover:bg-gray-100" v-for="item in findList"
                                            :key="item.id">
                                            <div class="relative flex items-start">
                                                ...
                                                <div class="ml-3 text-sm leading-6">
                                                    <label for="comments" class="font-medium text-gray-900">{{ item.lang
                                                    }}</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-4 flex items-center justify-center">
                                    <span class="text-xs font-extralight flex-1 ">选中 : </span>
                                    <span>
